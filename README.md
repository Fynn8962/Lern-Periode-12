...
- [x] Als Spieler möchte ich ein einfaches Menü haben, um Level zu starten, neu zu beginnen oder das Spiel zu beenden, damit die Bedienung übersichtlich bleibt.
...
**Arbeitspakete**
- [x] Implementieren einer Start- und Ziellinie, welche das Messen der Zeit ermöglichen.
- [x] Implementieren eines Timers, welcher bei der Startlinie automatische beginnt und beim Erreichen des Ziels stoppt. 
